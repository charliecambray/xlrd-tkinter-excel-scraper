...
Please note this is "dumb" search and looks for the full name of the freelancer. Spelling mistakes or accidental spaces will most likely
give you an error.
To initiate a search click the "Search" button at the top right.


*****Updating by discipline:*****

By checking the checkboxes to indicate what discipline you are looking for please consider that multiple discipline checkboxes checked
means that you are looking for a freelancer with ALL disciplines that have been checked. For example if you were to look for a LX Op
who is also a Sound OP please tick both boxes.
To update the list please click the "Update List" button just below the checkboxes.


To reset the list and see every entry just uncheck every discipline and press the "Update List" button.


*****ERRORS*****
"Workbook not found"
-You may get this if the program can't find the excel spreadsheet. This could be because it is not placed in the same directory as the exe/app file or if someone has renamed the excel spreadsheet to something other than “hf_pp2.xls".
